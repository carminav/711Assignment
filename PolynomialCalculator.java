...
public class PolynomialCalculator {
	 ...
	 *  This method is for your convenience so you can see your output.
	 *  Given a polynomial p in hashmap representation, return a string representation such that
	 *  a hashmap with key-value pairs:
	 * 	 5 -> 5
	 * 	 3 -> -1 
	 *	 0 -> 10
	 *  will return a string that looks like this:
	 *  "5x^5 - x^3 + 10" 
	 */
	...
	/*  ADD
	 *  Add polynomials p1 and p2, and return a new polynomial.
	 *  The returned answer should be simplified.
	 */
	public static HashMap<Integer, Integer> add(HashMap<Integer, Integer> p1, HashMap<Integer, Integer> p2) {
	...
	/*  SUBTRACT
	 *  Subtract polynomials p2 FROM p1, and return a new polynomial.
	 *  The returned answer should be simplified.
	 */
	public static HashMap<Integer, Integer> subtract(HashMap<Integer, Integer> p1, HashMap<Integer, Integer> p2) {
	...
	/*  SUBTRACT
	 *  Calculate the derivative of polynomial p and return it.
	 *  The returned answer should be simplified.
	 */
	public static HashMap<Integer, Integer> findDerivative(HashMap<Integer, Integer> p) {
	...
	public static void main(String args[]) {
		...
		System.out.println(PolynomialCalculator.toStringPoly(p1) + 
							" PLUS " + PolynomialCalculator.toStringPoly(p2) + 
							" = " + PolynomialCalculator.toStringPoly(answer));	
		
		// subtract
		answer = PolynomialCalculator.subtract(p3, p2);
		System.out.println(PolynomialCalculator.toStringPoly(p3) + 
							" MINUS " + PolynomialCalculator.toStringPoly(p2) + 
							" = " + PolynomialCalculator.toStringPoly(answer));	
